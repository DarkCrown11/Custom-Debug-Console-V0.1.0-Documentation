...
`Content Drawer→Plugins→Custom Debug Console Content→Custom Debug Console` or on the left side of the content drawer click All and search Custom Debug Console.<br/>
This way you can find the custom debug console widget. If you want you can create your console widget > :warning: **The console widget you create yourself will not include any built-in functions..**
